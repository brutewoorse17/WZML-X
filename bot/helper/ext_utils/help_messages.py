...
default_desp = {
    ...
    "MEGA_PROXY": "Single proxy URL for Mega SDK. Example: http://user:pass@host:port or socks5://host:port. Optional.",
    "MEGA_PROXIES": "Multiple proxies separated by comma or newline. One will be chosen per download based on MEGA_PROXY_STRATEGY.",
    "MEGA_PROXY_FILE": "Path to a file with one proxy per line. Lines starting with # are ignored.",
    "MEGA_PROXY_STRATEGY": "Proxy rotation strategy: round-robin (default) or random.",
